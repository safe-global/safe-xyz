...
export const Projects = ({ items }: BaseBlock): ReactElement => {
  ...
  return (
    <>
      <Container className={layoutCss.containerMedium + ' ' + css.wrapper}>
        <Cards items={items} />
        ...
        {isLoading ? (
          ...
          <Grid container spacing={GRID_SPACING}>
            <Grid size={{ xs: 12, md: 3 }} display="flex" alignItems="center" justifyContent="space-between">
              <Typography>
            ...
            <Grid size={{ xs: 12, md: 9 }} className={css.chipContainer}>
            ...
            <Grid size={{ xs: 12, md: 3 }} className={css.sidebar}>
              {sidebar}
            </Grid>
              ...
              {visibleResults.length > 0 ? (
                <Grid container spacing={GRID_SPACING} display="flex" alignContent="flex-start">
                  {visibleResults.map((project, idx) => (
                    <Grid size={{ xs: 12, md: 6, lg: 4 }} key={project.project + idx}>
                      <ProjectCard {...project} />
                    </Grid>
                  ))}
                  {shouldShowMoreButton && (
                    <Grid size={{ xs: 12 }} mt={{ xs: 2, md: 0 }} display="flex" justifyContent="center">
                      <NextLink
